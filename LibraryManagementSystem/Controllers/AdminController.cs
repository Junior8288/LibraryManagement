    ...
    public class AdminController : Controller
    {
        public IActionResult Index(string filter = "all")
        {
            try
            {
                ...
                ViewBag.PendingCount = BookDataStore.GetPendingCount();
                ViewBag.ApprovedCount = BookDataStore.GetApprovedCount();
                ViewBag.DeclinedCount = BookDataStore.GetDeclinedCount();
